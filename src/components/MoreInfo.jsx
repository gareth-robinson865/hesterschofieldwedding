export default function MoreInfo() {
  return (
    <div>
        ...
        <h5>Reception</h5>
        <p>Approx 5 minutes drive to the reception venue of Castle Farm Barn, Knaresborough, please see your invite for directions.</p>
        ...
        <h5>Outfits</h5>
        <p>We would love it if you could join us and wear black tie and cocktail party style wedding attire.</p>
